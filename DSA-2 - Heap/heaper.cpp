// 
// This program allows the user to manipulate a binary BinaryHeap.
// The program only inserts string ids with associated keys
// into the BinaryHeap. The BinaryHeap class, however, is capable of storing
// arbitrary pointers along with each BinaryHeap item.
//
...
int main()
{
  ...
  // Have user choose capacity for binary BinaryHeap
  getInteger("Choose a capacity for the binary BinaryHeap: ", capacity);

  // Create the BinaryHeap
  BinaryHeap myHeap1(capacity);

  while (1) {
    cout << "\nOptions:" << endl;
    cout << "1 - Insert a new item into the binary BinaryHeap" << endl;
    ...
    case 1:
      // Get data to insert into BinaryHeap from the user and insert it
    ...
    case 3:
      // Get id string from user and delete it from the BinaryHeap
    ...
    case 4:
      // Perform the deleteMin operation on the BinaryHeap
